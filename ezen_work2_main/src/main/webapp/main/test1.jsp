		...
		<nav style="width: 1150px; margin-left: 127px;">
		  <div class="nav nav-tabs" id="nav-tab" role="tablist">
		    ...
		    <button class="nav-link" id="nav-profile-tab" data-bs-toggle="tab" data-bs-target="#nav-profile" type="button" role="tab" aria-controls="nav-profile" aria-selected="false"
		    	onclick="location.href='index.jsp?req=talk'">한줄톡
		    </button>
     ...
     <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center" style="width:1200px; height: 300; margin-left:auto; margin-right:auto; position: inherit;">
         ...
         <div class="col mb-5">
             <div class="card h-100">
                 <!-- Product image-->
                 <a href="../member/member_apply/memberAdViewForm.jsp">
                 	<img class="card-img-top" src="../storage/${dto.image}" alt="..." onclick="checkMember();"/>
                 </a>
                 <!-- Product details-->
