		...
		<div id="carouselExampleFade" class="carousel slide carousel-fade"
			...
			<div class="carousel-inner">
				<div class="carousel-item active" data-bs-interval="2500">
					<img src="../img/444.png" class="d-block w-100" alt="..."
						style="width: 1000px; height: 400px;">
				</div>
				<div class="carousel-item" data-bs-interval="2500">
					<img src="../img/222.png" class="d-block w-100" alt="..."
						style="width: 1000px; height: 400px;">
				</div>
				<div class="carousel-item" data-bs-interval="2500">
		...
		<nav style="width: 1150px; margin-left: 127px;">
			<div class="nav nav-tabs" id="nav-tab" role="tablist">
				...
				<button class="nav-link" id="nav-profile-tab" data-bs-toggle="tab"
					...
					aria-controls="nav-profile" aria-selected="false">지역별/업종별</button>
				...
				<button class="nav-link" id="nav-contact-tab" data-bs-toggle="tab"
					data-bs-target="#nav-contact" type="button" role="tab"
					aria-controls="nav-contact" aria-selected="false">이벤트</button>
				<button class="nav-link" id="nav-profile-tab" data-bs-toggle="tab"
					data-bs-target="#nav-profile" type="button" role="tab"
					aria-controls="nav-profile" aria-selected="false">공지사항</button>
				<button class="nav-link" id="nav-contact-tab" data-bs-toggle="tab"
					data-bs-target="#nav-contact" type="button" role="tab"
					aria-controls="nav-contact" aria-selected="false"
