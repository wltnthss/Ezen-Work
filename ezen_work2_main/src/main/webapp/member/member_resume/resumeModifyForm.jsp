...
<div id="SubWrap">
	...
	<div id="SubContents">
		...
		<div id="Contents">
		<div id="step1">	
		<form name="resumeModifyForm" id="regResume" method="post" action="resumeModify.do?seq=${seq }&pg=${pg}" enctype="multipart/form-data">	
			<!-- 개인정보 -->
		...
		<div id="step2">
			<!-- 희망근무 조건 -->
				...
				<button type="submit" class="join-submit-btn join-submit-btn--person">이력서 수정 완료</button>
		</form>
		</div>
		</div>
	</div>
