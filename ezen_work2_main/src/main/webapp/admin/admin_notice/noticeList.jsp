...
<body>
	<form action="noticeList.do" name=noticeList method="post" enctype="utf-8">
		<div style="margin-left: 450px; font-size: 30px; font-weight: bold;">			
		...
		<div id="header">			
			<c:if test="${amemId != null}">
				<a href="../admin_notice/noticeWriteForm.jsp"><button type="button" class="btn btn-outline-success" style="margin-right: 900px;">글쓰기</button></a>
			</c:if>
		</div>
		<br>
		<div class="middle">
			<table style="text-align: center;" class="table table-hover">
				...
				<c:forEach var="dto" begin="0" end="19" items="${list}">
					<tr>
						<td>${dto.seq}</td>
						<td><a id="subject"  href="#" onclick="isLogin(${dto.seq})">${dto.subject}</a></td>
						<td>${dto.id}</td>
						<td>${dto.day}</td>
						<td>${dto.count}</td>
					</tr>
	...
	<!--  
	<a href="../admin_notice/noticeWriteForm.jsp">새글 쓰기</a><br>
	 -->
	<!-- 상세 보기에서 게시글 삭제하기 만들기 -->
	<!-- 삭제하기 만들기 *.do?seq=seq&pg=pg  -->
	<!-- 
	<a href="../admin_main/admin_main.jsp">관리자 페이지</a> 
	 -->
