...
function checkNoticeWrite() {
	//alert("test");
	var frm = document.noticeWriteForm1;
...
<body>
	<form action="noticeWriteForm.do" method="post" name="noticeWriteForm1">
		...
		<table>
			...
			<tr>
				<td colspan="2" align="center">
					<input type="image" src="../image/enroll.JPG" alt="등록" onclick="checkNoticeWrite(); return false;"/>
