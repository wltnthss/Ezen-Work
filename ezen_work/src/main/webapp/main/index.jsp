...
<html lang="ko">
  ...
  <body>
    <!-- Navigation-->
       ...
       <a href="index.jsp"><img alt="곰탱이" src="../img/br.jpg"; style="height: 120px"; width="120px"; align="middle"></a>  
         ...
         <a href="#"><em style = " font-style:normal; font-size : 15px ; color : red ; float : right; padding-top: 25px">&nbsp로그인</em></a>
         <a href="#"><em style = " font-style:normal; font-size : 15px ; color : red ; float : right; padding-top: 25px">&nbsp회원가입</em></a>
