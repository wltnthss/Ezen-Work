...
<body>
	<form action="advertiseModify.do" method="post" name="advertiseModifyForm" enctype="multipart/form-data">
		<table>
			...
			<tr>
				<th>공고 내용</th>
				<td><textarea rows="15" cols="45" name="ad_content">${dto.ad_content}</textarea></td>
			</tr>
			<tr>
				<th>모집인원</th>
				<td>
			...
			<tr>
				<th>위치(지역)</th>
				<td><input type="text" name="ad_area" size="30" value="${dto.ad_area}"></td>
			</tr>
			<tr>
				<th>직종</th>
				<td>
			...
			<tr>
				<th>시급</th>
				<td><input type="text" name="salary" size="5" value="${dto.salary}"></td>
			</tr>
			<tr>
				<th>회사명</th>
				<td><input type="text" name="cname" size="10" value="${dto.cname}"></td>
			</tr>
			<tr>
				<th>기타</th>
				<td><textarea rows="15" cols="45" name="content">${dto.content}</textarea></td>
			</tr>
			<tr>				
				<td colspan="2" align="center">
					<input type="button" value="공고수정" onclick="checkModify();">
