...
<body>
	...
	<table class="detail">
		...
		<tr align="center">
			<td width="120" style="font_weight: bold; font-size: 20px;">글번호 : ${dto.e_seq }</td>
	...
	<div style="margin-left: 1330px;">
		<input type="button" value="목록" onclick="location.href='eventList.do?pg=${pg }'">
		<!-- <input type="button" value="글 수정" onclick="location.href='eventModify.do?seq=${seq }&pg=${pg }'"> -->
		<c:if test="${amemId != null}">
		<input type="button" value="글 삭제" onclick="location.href='eventDelete.do?seq=${seq }&pg=${pg }'">
		</c:if>
	</div>
</body>
</html>