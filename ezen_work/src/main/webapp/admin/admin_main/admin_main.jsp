...
<html lang="en">
  ...
  <body>
   <div class="container px-4 py-5" id="featured-3">    
    <h2 class="pb-2 border-bottom">지수폰트적용 관리자페이지 <a href="../admin_login/logout.do" style="font-size: 15px; float:right; text-decoration: none;"><button type="button" class="btn btn-outline-secondary">로그아웃</button></a></h2>    
    <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
      ...
      <div class="feature col"> 		
        ...
        <h2>알바경험담 페이지</h2>
        <p></p>
        <a href="../admin_exp/job_experience_main.do?pg=1" target="_blank" class="icon-link">
          Go to experience
          <svg class="bi" width="1em" height="1em"><use xlink:href="#chevron-right"/></svg>
        </a>
      </div>
