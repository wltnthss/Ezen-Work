...
<!-- API 연동 -->
<script type="src="https://developers.kakao.com/sdk/js/kakao.js"></script>
<script type="text/javascript">
	//f3676c5bda16eec7ed57df64654e01ae
	window.Kakao.init("f3676c5bda16eec7ed57df64654e01ae";)
...
<header id="Header">
	<div id="HeaderGnb">
			...
			<h1><a href="../../main/index.jsp"><img src="../images/Ezen_Work.png" alt="이젠일해요"></a></h1>
