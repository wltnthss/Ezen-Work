	...
	<div id="Header">	
		...
		<div id="HeaderMenu">
			...
			<ul class="headerMenu headerMenu--login">				
				<li class="person on">
					<a href="../mypage/mypageForm.jsp"><span></span>마이페이지</a>	
				</li>		
				<li class="job">
...
<div id="PersonHead1" class="person-head">
	...
	<div class="person-head__wrap">
		<div class="person-head__who">
			...
			<a href="../regist/memberModify1.do" class="person-head__who-modify" target="_blank">개인정보수정</a>
		</div>

		<ul class="person-head__state">
			<li class="person-head__state-item--resume">				
					<a class="state-item__link state-item__link--Y">
			...
			<table id="resumelist" cellspacing="0" summary="내 이력서 목록">
				...
				<tbody>
					...
					<tr class="default"> 	
						...
						<td class="mag">		
						<a class="button-type" href="">확인</a> 	<!-- 이력서상세보기 주소 -->
					</tr> 
					</c:forEach>
					<!-- 페이지 표시 -->
					<tr>
